...
function App() {
  const [toggle, setToggle] = useState({ news: true, vote: false });
    ...
    <Router>
      <div className="container mx-auto py-2 items-center flex">
        ...
        <div className="grow flex justify-center items-center gap-4 mr-16">
          <div className="py-2">
            <button
              onClick={() => setToggle({ news: true, vote: false })}
              className={
                toggle.news
            ...
            <button
              onClick={() => setToggle({ news: false, vote: true })}
              className={
                toggle.vote
            ...
            >
              <NavLink className="active px-4 " to="/vote">
                Голосование
              </NavLink>
            </button>
          </div>
