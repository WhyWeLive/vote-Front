    ...
    >
      ...
      {elected.map((item) => (
        <div className={"flex flex-col gap-2"}>
          ...
          <label
            htmlFor={`${item}`}
            className=" w-full h-full flex py-4 cursor-pointer rounded-xl peer-checked:bg-gray-200 peer-checked:shadow duration-500 hover:bg-stone-100 peer-checked:text-[#2196f3]"
          >
            <div
              className={
