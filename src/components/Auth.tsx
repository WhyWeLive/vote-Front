...
export const Auth = ({ toAuth }) => {
	...
	const {
		mutate,
		isLoading
	} = useMutation('login', () => axios.get(API_URL, { headers: { 'Content-Type': 'application/json' } }), {
			onSuccess: ({ data }) => {
				toAuth(true)
			}
	...
	return (
		<div className='w-screen h-screen flex justify-center bg-gray-100'>
			...
			<div className='p-6 my-48 border shadow w-96 h-128 rounded-lg bg-white flex items-center flex-col'>
				...
				<img src={'https://cdn-icons-png.flaticon.com/512/3237/3237472.png'} className='h-16 w-16 my-5' />
					...
					<div className='my-10'>
						<div className='mt-1 border-b border-gray-300 focus-within:border-indigo-600 flex'>
							...
							<button onClick={() => setEye(prev => !prev)}>
								<img
									src={eye ? 'https://cdn-icons-png.flaticon.com/512/2767/2767146.png' : 'https://cdn-icons-png.flaticon.com/512/709/709612.png'}
